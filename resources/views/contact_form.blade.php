            ...
            <div class="container">
                <div class="card" style="margin-top: 100px; margin-bottom:100px;">
                    <div class="card-header">
                        ...
                        <p class="text-muted">Silahkan kirim pesan</p>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="nama_pengirim" class="form-control"
                                            placeholder="Nama Anda" value="{{ old('nama_pengirim') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" name="email_pengirim" class="form-control"
                                            placeholder="Alamat Email" value="{{ old('email_pengirim') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="wa_pengirim" class="form-control"
                                            placeholder="Nomor WhatsApp" value="{{ old('wa_pengirim') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <textarea maxlength="400" name="pesan_pengirim" class="form-control" placeholder="Pesan Anda"
                                            style="width: 100%; min-height: 160px;" required>{{ old('pesan_pengirim') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
